...
const bookToSeason: Record<string, { id: string; testament: "old" | "new"; name: string; slug: string; desc: string }> = {
  ...
  Psalms: { id: "s-psalms", testament: "old", name: "Psalms", slug: "psalms", desc: "Songs of praise, lament, and everything in between. The soundtrack of Israel's soul." },
  Job: { id: "s-job", testament: "old", name: "Job", slug: "job", desc: "Why do good people suffer? One man loses everything and demands answers from God." },
  Proverbs: { id: "s-proverbs", testament: "old", name: "Proverbs", slug: "proverbs", desc: "Street-smart wisdom from the wisest king. Money, relationships, work, and the fear of the Lord." },
  Isaiah: { id: "s-isaiah", testament: "old", name: "Isaiah", slug: "isaiah", desc: "The greatest prophet. Visions of judgment, a suffering servant, and a coming King." },
  Jeremiah: { id: "s-jeremiah", testament: "old", name: "Jeremiah", slug: "jeremiah", desc: "The weeping prophet. Called as a teenager to deliver messages nobody wants to hear." },
  Ezekiel: { id: "s-ezekiel", testament: "old", name: "Ezekiel", slug: "ezekiel", desc: "Wild visions, performance art prophecy, and a valley full of bones that come back to life." },
  Hosea: { id: "s-hosea", testament: "old", name: "Hosea", slug: "hosea", desc: "A prophet ordered to marry a prostitute. A gut-wrenching love story about God and Israel." },
  Epistles: { id: "s-epistles", testament: "new", name: "Epistles", slug: "epistles", desc: "Letters from apostles to early churches. Theology, practical advice, and the blueprint for Christian living." },
};

// Handle the edge case in the catalog
const bookAliases: Record<string, string> = {
  "Genesis 25,": "Genesis",
  "1 Samuel 24": "1 Samuel",
  "Psalm": "Psalms",
  "Psalms 42, 51": "Psalms",
  "Jeremiah 1, 20": "Jeremiah",
  "1 Corinthians": "Epistles",
  "Ephesians": "Epistles",
  "1 Timothy 1, 2 Timothy": "Epistles",
  "Romans": "Epistles",
  "Psalm 51": "Psalms",
  "Psalm 91": "Psalms",
  "Psalm 139": "Psalms",
  ...
  "Isaiah 7": "Isaiah",
  "Isaiah 65-66": "Isaiah",
  "Jeremiah 18-19": "Jeremiah",
  "Jeremiah 38": "Jeremiah",
  "Jeremiah 31": "Jeremiah",
  "Ezekiel 1-3": "Ezekiel",
  "Ezekiel 47": "Ezekiel",
  "Hosea 2-3": "Hosea",
  "Hosea 11, 14": "Hosea",
  "Hosea 11": "Hosea",
  "2 Chronicles 5-7": "2 Chronicles",
  "2 Chronicles 29-30": "2 Chronicles",
  "James 3": "Epistles",
  "James 2": "Epistles",
  "2 Peter 2-3": "Epistles",
