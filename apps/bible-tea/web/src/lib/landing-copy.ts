...
const EN: Record<LandingId, Omit<LandingCopy, "canonicalPath" | "esPath" | "campaign" | "featuredIds">> = {
  bff: {
    ...
    subtitle:
      "Bible BFF is a different app. If you wanted modern Bible stories that sound like a friend — the tea-girl voice, not a pulpit — that’s Bible Tea.",
    ...
    about: [
      "Most people searching “Bible BFF” mean Bible Bff — Modern Bible Stories (Idea Garden). There is another app called Bible BFF: Stories & Drama (Looma Labs). Neither one is Bible Tea. There is also a Bible BFF podcast. That is not us either.",
      "Bible Tea retells the real stories as short audio — the drama, the betrayal, the comeback — in a voice that sounds like tea with a friend. You can ask the in-app companion what a story means. There is a daily verse widget for your home screen. The catalog is English and Spanish.",
      "If you want Bible BFF, get it from the App Store or Google Play. If you downloaded the wrong one looking for the tea girl, you’re in the right place.",
    ],
    compare: {
      title: "Side by side",
      them: "Bible BFF",
      rows: [
        ...
        { label: "Verse widget", tea: "Home screen and lock screen", them: "Not the reason people search it" },
        { label: "Languages", tea: "English and Spanish", them: "Check their store listing" },
        { label: "Price", tea: "Free to download. Full library is a subscription, priced in the store.", them: "Subscription through the stores. Searchers often ask if it is free." },
      ],
    },
    ...
    faqTitle: "Before you download the wrong app",
    faqs: [
      {
        q: "What is Bible BFF?",
        a: "Bible BFF is a separate modern-Bible-stories app. People search it for audio stories, chat, and verses. It is not Bible Tea.",
      },
      {
        q: "Is Bible Tea the same as Bible BFF?",
        a: "No. Bible Tea is the app people describe as “the Bible that sounds like tea.” Same job — hear the stories — different voice, different catalog, different company.",
      },
      {
        q: "Is Bible BFF free?",
        a: "Their download is free. Reviews and searches (“is Bible BFF free”, “Bible BFF cost”) show a store subscription for the full library. Bible Tea is also free to download; the full story library is a subscription priced in the App Store or Google Play, not on this page.",
      },
      {
        q: "What are apps like Bible BFF?",
        a: "If you want modern audio Bible stories, Bible Tea is the one built as a storycast: short episodes, a companion chat, prayers, and a verse widget. YouVersion is a reader. Haven is a chat app.",
      },
      {
        q: "Is there a Bible BFF podcast?",
        a: "Yes — a different show. Searching “Bible BFF” also surfaces that podcast. This page is about the story apps, and about Bible Tea.",
      },
      {
        q: "Where do I get Bible Tea?",
        a: "iPhone and Android. Download Bible Tea, pick a story, tap play.",
      },
    ],
    finalTitle: "If you wanted the tea girl",
    finalDesc: "Download Bible Tea. One story. Then you know.",
  ...
  haven: {
    ...
    compare: {
      ...
      rows: [
        ...
        { label: "Prayer", tea: "Guided prayers in the app", them: "Prayer inside chat" },
        { label: "Verse widget", tea: "Home screen daily verse", them: "Check their listing" },
        { label: "Languages", tea: "English and Spanish", them: "Check their listing" },
        { label: "Price", tea: "Free to download. Full library is a subscription, priced in the store.", them: "Subscription through the stores" },
      ],
    },
    disclaimer: "Haven is a trademark of its owners. This page is about Bible Tea. We do not run or speak for Haven.",
    faqTitle: "Chat vs stories",
    faqs: [
      {
        q: "What is Haven Bible Chat?",
        a: "Haven is a separate AI Bible chat app. People use it to ask questions, pray, and study. It is not Bible Tea.",
      },
      {
        q: "Does Bible Tea have Bible chat?",
        a: "Yes. There is an in-app companion. It is there to talk about the stories and to help you pray — after you have heard the episode, not instead of it.",
      },
      {
        q: "Is Bible Tea the same as Haven?",
        a: "No. Haven is chat-first. Bible Tea is story-first: audio episodes, then chat, prayers, and a verse widget.",
      },
      {
        q: "Is the chat a pastor or God?",
        a: "No. It is AI. It will say so. It is not a therapist and it is not Scripture. The stories point you back to the passage.",
      },
      {
        q: "Where do I get Bible Tea?",
        a: "iPhone and Android. Download Bible Tea from the App Store or Google Play.",
      },
    ],
...
const ES: Record<LandingId, Omit<LandingCopy, "canonicalPath" | "esPath" | "campaign" | "featuredIds">> = {
  bff: {
    ...
    description:
      "¿Buscas una alternativa a Bible BFF? Bible Tea es historias bíblicas en audio, con voz de amiga — más chat, oración y widget. No es la app Bible BFF.",
    breadcrumb: "Alternativa a Bible BFF",
    h1: "Alternativa a Bible BFF",
    subtitle:
      "Bible BFF es otra app. Si querías historias bíblicas modernas que suenan como una amiga — la voz del té, no un púlpito — eso es Bible Tea.",
    ...
    about: [
      "Quien busca “Bible BFF” suele querer Bible Bff — Modern Bible Stories (Idea Garden). Hay otra app, Bible BFF: Stories & Drama (Looma Labs). Ninguna es Bible Tea. También hay un podcast con ese nombre. Tampoco somos nosotros.",
      "Bible Tea cuenta las historias de verdad en audio corto — el drama, la traición, el regreso — con voz de té con una amiga. En la app puedes preguntarle al compañero qué significa. Hay un widget de versículo para la pantalla de inicio. El catálogo está en inglés y en español.",
      "Si quieres Bible BFF, bájala de la App Store o de Google Play. Si bajaste la otra buscando a la chica del té, aquí es.",
    ],
    compare: {
      title: "Lado a lado",
      them: "Bible BFF",
      rows: [
        ...
        { label: "Precio", tea: "Gratis para descargar. La biblioteca completa es suscripción, el precio está en la tienda.", them: "Suscripción por las tiendas. La gente pregunta si es gratis." },
      ],
    },
    disclaimer: "Bible BFF es marca de sus dueños. Esta página es de Bible Tea. No operamos ni hablamos por sus apps.",
    faqTitle: "Antes de bajar la app equivocada",
    faqs: [
      {
        q: "¿Qué es Bible BFF?",
        a: "Bible BFF es otra app de historias bíblicas modernas. La buscan por audio, chat y versículos. No es Bible Tea.",
      },
      {
        q: "¿Bible Tea es lo mismo que Bible BFF?",
        a: "No. Bible Tea es la app que la gente describe como “la Biblia que suena a té”. El mismo trabajo — oír las historias — otra voz, otro catálogo, otra empresa.",
      },
      {
        q: "¿Bible BFF es gratis?",
        a: "Su descarga es gratis. Las búsquedas (“is Bible BFF free”) hablan de una suscripción en la tienda para la biblioteca. Bible Tea también se descarga gratis; la biblioteca completa es una suscripción con el precio en App Store o Google Play, no en esta página.",
      },
      {
        q: "¿Qué apps hay como Bible BFF?",
        a: "Si quieres historias bíblicas en audio moderno, Bible Tea es el storycast: episodios cortos, chat, oraciones y widget. YouVersion es un lector. Haven es un chat.",
      },
      {
        q: "¿Hay un podcast de Bible BFF?",
        a: "Sí — otro programa. Buscar “Bible BFF” también saca ese podcast. Esta página es de las apps de historias, y de Bible Tea.",
      },
      {
        q: "¿Dónde bajo Bible Tea?",
        a: "iPhone y Android. Descarga Bible Tea, elige una historia, toca play.",
      },
    ],
    finalTitle: "Si buscabas a la chica del té",
    finalDesc: "Descarga Bible Tea. Una historia. Luego lo sabes.",
  ...
  haven: {
    ...
    compare: {
      ...
      rows: [
        ...
        { label: "Oración", tea: "Oraciones guiadas en la app", them: "Oración dentro del chat" },
        { label: "Widget", tea: "Versículo diario en la pantalla", them: "Mira su ficha" },
        { label: "Idiomas", tea: "Inglés y español", them: "Mira su ficha" },
        { label: "Precio", tea: "Gratis para descargar. La biblioteca completa es suscripción, el precio está en la tienda.", them: "Suscripción por las tiendas" },
      ],
    },
    disclaimer: "Haven es marca de sus dueños. Esta página es de Bible Tea. No operamos ni hablamos por Haven.",
    faqTitle: "Chat o historias",
    faqs: [
      {
        q: "¿Qué es Haven Bible Chat?",
        a: "Haven es otra app de chat bíblico con IA. La usan para preguntar, orar y estudiar. No es Bible Tea.",
      },
      {
        q: "¿Bible Tea tiene chat bíblico?",
        a: "Sí. Hay un compañero en la app. Sirve para hablar de las historias y para orar — después del episodio, no en lugar de él.",
      },
      {
        q: "¿Bible Tea es lo mismo que Haven?",
        a: "No. Haven es primero chat. Bible Tea es primero historia: episodios de audio, luego chat, oraciones y widget.",
      },
      {
        q: "¿El chat es un pastor o Dios?",
        a: "No. Es IA. Lo dice. No es terapeuta y no es Escritura. Las historias te devuelven al pasaje.",
      },
      {
        q: "¿Dónde bajo Bible Tea?",
        a: "iPhone y Android. Descarga Bible Tea en App Store o Google Play.",
      },
    ],
