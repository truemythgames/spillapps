...
const ES_SLUG_OVERRIDES: Record<string, string> = {
  ...
  "/bible-stories-for-sleep": "/historias-biblicas-para-dormir",
  "/bible-bff-alternative": "/alternativa-bible-bff",
  "/bible-stories-for-adults": "/historias-biblicas-para-adultos",
  "/bible-for-beginners": "/biblia-para-principiantes",
  "/haven-bible-chat-alternative": "/alternativa-haven-bible-chat",
...
export const GET: APIRoute = async () => {
  ...
  const entries: SitemapEntry[] = [
    ...
    { path: "/bible-stories-for-sleep", lastmod: today, changefreq: "weekly", priority: 0.85 },
    { path: "/bible-bff-alternative", lastmod: today, changefreq: "weekly", priority: 0.9 },
    { path: "/bible-stories-for-adults", lastmod: today, changefreq: "weekly", priority: 0.9 },
    { path: "/bible-for-beginners", lastmod: today, changefreq: "weekly", priority: 0.9 },
    { path: "/haven-bible-chat-alternative", lastmod: today, changefreq: "weekly", priority: 0.85 },
