...
const APP_STORE_URL = "https://apps.apple.com/app/bible-tea-bible-storycast/id6761665565";
const PLAY_STORE_URL = "https://play.google.com/store/apps/details?id=app.bibletea";
      ...
      <View style={styles.backdrop}>
        <View style={styles.card}>
          ...
          <Text style={styles.message}>
            A new version of Bible Tea is available with important improvements. Please update to continue enjoying the best experience.
          </Text>
          <TouchableOpacity
