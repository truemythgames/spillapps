...
export default function CompletedScreen() {
  ...
  const items = forPrayers
    ? newestFirst(completedIds.filter(isPrayerPlayerId))
        .map((id) => {
    ...
    : newestFirst(completedIds.filter((id) => !isPrayerPlayerId(id)))
        .map((id) => {
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {forPrayers ? t("completedScreen.prayerTitle") : t("completedScreen.title")}
        </Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      {items.length === 0 ? (
        <View style={styles.empty}>
          ...
          <Text style={styles.emptyTitle}>
            {forPrayers ? t("completedScreen.emptyPrayerTitle") : t("completedScreen.emptyTitle")}
          </Text>
          <Text style={styles.emptySub}>
            {forPrayers ? t("completedScreen.emptyPrayerDesc") : t("completedScreen.emptyDesc")}
          </Text>
        </View>
      ) : (
