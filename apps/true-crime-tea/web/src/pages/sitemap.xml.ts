...
const SITE = "https://truecrimetea.app";
...
export const GET: APIRoute = async () => {
  ...
  const entries: SitemapEntry[] = [
    ...
    { loc: SITE + "/cases", lastmod: today, changefreq: "weekly", priority: 0.8 },
  ...
  for (const season of seasons) {
    entries.push({ loc: `${SITE}/cases/${season.slug}`, lastmod: today, changefreq: "monthly", priority: 0.6 });
  }
