      ...
      <View style={styles.section}>
        ...
        <View style={styles.testamentRow}>
          <Pressable style={styles.testamentCard} onPress={() => router.push("/testament/old")}>
            <Image source={{ uri: storyMap["jack-the-ripper"]?.cover_image_url ?? coverUrl("jack-the-ripper") }} style={styles.testamentImg} contentFit="cover" transition={300} />
            <View style={styles.testamentOverlay} />
            <View style={styles.testamentContent}>
              <Text style={styles.testamentLabel}>{t("explore.ancientMedieval")}</Text>
              <Text style={styles.testamentSub}>{t("explore.pre1500")}</Text>
            </View>
          </Pressable>
          <Pressable style={styles.testamentCard} onPress={() => router.push("/testament/new")}>
            <Image source={{ uri: storyMap["gardner-museum-heist"]?.cover_image_url ?? coverUrl("gardner-museum-heist") }} style={styles.testamentImg} contentFit="cover" transition={300} />
            <View style={styles.testamentOverlay} />
            <View style={styles.testamentContent}>
              <Text style={styles.testamentLabel}>{t("explore.modernEra")}</Text>
              <Text style={styles.testamentSub}>{t("explore.post1500")}</Text>
            </View>
          </Pressable>
        </View>
      </View>
