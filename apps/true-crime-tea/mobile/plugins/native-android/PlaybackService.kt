...
class PlaybackService : Service() {
  ...
  companion object {
    const val ACTION_UPDATE = "app.truecrimetea.playback.UPDATE"
    const val ACTION_STOP = "app.truecrimetea.playback.STOP"
    const val CHANNEL_ID = "truecrimetea_playback"
  ...
  private var currentTitle: String = "True Crime Tea"
  private var currentArtist: String = "True Crime Tea"
  ...
  private fun loadArtworkAsync(url: String) {
    thread(start = true, isDaemon = true, name = "truecrimetea-artwork") {
      try {
