...
// TODO: replace App Store URL once published
const APP_STORE_URL = "https://truecrimetea.app";
const PLAY_STORE_URL = "https://play.google.com/store/apps/details?id=app.truecrimetea";
      ...
      <View style={styles.backdrop}>
        <View style={styles.card}>
          ...
          <Text style={styles.message}>
            A new version of True Crime Tea is available with important improvements. Please update to continue enjoying the best experience.
          </Text>
          <TouchableOpacity
